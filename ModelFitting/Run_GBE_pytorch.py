...
def run_model(lte, outcomeAmount, mood_rating, time, pen_betaE, pen_betaA, pen_betaT,
    ...
    for iter_no in range(n_iterations):
        ...
        reg_pen = pen_betaE * pt.sum(par_betaE**2) +                     pen_betaA * pt.sum(par_betaA**2) +                     pen_betaT * pt.sum(par_betaT**2)
...
def LoadDataAndRunModel(data_file='Mmi-gbeExplore_TrialForMdls.csv', n_subjects=5000, n_trials = 30,
                        pen_betaE=0.1, pen_betaA=0.1, pen_betaT=0.1,
    ...
    pars, losses, mood_pred, obj_fn = run_model(lte=lte, outcomeAmount=outcomeAmount, mood_rating=mood_rating, time=time,
              pen_betaE = pen_betaE, pen_betaA = pen_betaA, pen_betaT = pen_betaT,
...
parser.add_argument('-pt','--pen_betaT', default='33.6', help='regularization penalty on beta_T parameter')
...
if __name__ == '__main__':
    ...
    LoadDataAndRunModel(data_file = args.data_file, n_subjects = int(args.n_subjects), n_trials = int(args.n_trials),
                        pen_betaE = float(args.pen_betaE), pen_betaA = float(args.pen_betaA), pen_betaT = float(args.pen_betaT),
